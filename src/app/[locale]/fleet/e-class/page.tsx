...
const galleryImages = [
  "/fleet/e-class-2.webp",
  "/fleet/e-class-3.webp",
  "/fleet/e-class-4.webp",
  "/fleet/e-class-5.webp",
  "/fleet/e-class-6.webp",
  "/fleet/e-class-1.webp",
];
...
export default function EClassPage() {
  ...
  const features = t.raw("eClass.features") as string[];
  const specs = t.raw("eClass.specs") as { label: string; value: string }[];
  const faqs = t.raw("eClass.faq") as { question: string; answer: string }[];
