...
const galleryImages = [
  "/fleet/s-class-2.webp",
  "/fleet/s-class-3.webp",
  "/fleet/s-class-4.webp",
  "/fleet/s-class-5.webp",
  "/fleet/s-class-6.webp",
  "/fleet/s-class-1.webp",
];
...
export default function SClassPage() {
  ...
  const features = t.raw("sClass.features") as string[];
  const specs = t.raw("sClass.specs") as { label: string; value: string }[];
  const faqs = t.raw("sClass.faq") as { question: string; answer: string }[];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="font-display text-4xl md:text-6xl font-bold text-cream leading-tight mb-6">
                {t("sClass.title")} <span className="neon-text">{t("sClass.highlight")}</span>
              </h1>
              <p className="text-base text-ash leading-relaxed mb-8">
                {t("sClass.description")}
              </p>
